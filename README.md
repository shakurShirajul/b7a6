...
| `READINESS_TIMEOUT_MS`             | No       | Per-dependency `/ready` probe deadline in milliseconds; defaults to `1500`.                                                                   |
