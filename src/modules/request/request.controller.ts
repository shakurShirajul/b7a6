...
const getBloodsRequests = catchAsync(async (req: Request, res: Response) => {
...
const getDonorRequestById = catchAsync(async (req: Request, res: Response) => {
  const id = req.params.id;
...
const approveBloodRequest = catchAsync(async (req: Request, res: Response) => {
  const id = req.params.id;
